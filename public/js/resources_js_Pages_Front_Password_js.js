(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_Pages_Front_Password_js"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (props) {
  ...
  if (flash.message) (0,react_toastify__WEBPACK_IMPORTED_MODULE_7__.toast)(flash.message); //menangani perubahan nilai input pada form
  ...
  function handleSubmit(e) {
    e.preventDefault();
    _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_2__.Inertia.put(route('password.update'), values).then(function () {
      setValues({
        password: "",
        password1: "",
        password2: ""
